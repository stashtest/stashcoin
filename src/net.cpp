...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Stashcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seeds.stashgroup.net", "seeds.stashgroup.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"testnet.stashgroup.net", "testnet.stashgroup.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Stashcoin is probably already running."), addrBind.ToString().c_str());
        else
